...
enum WgIdent { case none,saveLoad,loadNext,reset,help,coloring,shadow,win3D,stereo,f1,f2,f3,f4,grammar,gRandom,gString,function,auto,random,radial }
...
class WidgetGroup: NSView {
    ...
    func addDropDown(_ hotKey:String, _ iname:String, _ ident:WgIdent) {
    ...
    func drawEntry(_ index:Int) {
        ...
        case .dropDown : drawText(Tab1,py+TxtYoff,tColor,FontSZ, (delegate?.wgGetString(data[index].ident))!)
