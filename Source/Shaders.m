...
void controlRandom(void) {
    ...
    cPtr->color.x = rndF(0.1,1);
    cPtr->color.y = rndF(0.1,1);
    cPtr->color.z = rndF(0.1,1);
...
int  getEquationIndex(int fIndex) { return cPtr->function[fIndex].index; }

void setEquationIndex(int fIndex, int index) { cPtr->function[fIndex].index = index; }
...
void controlAutoMove(void) {
    ...
    for(int i=0;i<NUM_AUTO;++i) {
        ...
        switch(i) {
            ...
            case 3 : cPtr->color.x += amt; break;
            case 4 : cPtr->color.y += amt; break;
            case 5 : cPtr->color.z += amt; break;
            case 6 :
            case 11:
            case 16:
            case 21:
